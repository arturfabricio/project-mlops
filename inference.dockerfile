...
COPY data/processed/images/churros/1601.jpg data/processed/images/churros/1601.jpg
...
# # Add the --image_path argument to the entrypoint
# ENTRYPOINT ["python", "-u", "src/models/inference.py", "--image_path"]