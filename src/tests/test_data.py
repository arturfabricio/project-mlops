...
def test_data():
    ...
    assert len(train_dataset) == int(num_images*0.8), "The train batches don't match the amount of data points"
    assert len(val_dataset) == int(num_images*0.2), "The test batches don't match the amount of data points"
